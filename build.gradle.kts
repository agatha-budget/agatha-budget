...
val HEROKU_TRESORIER_DB: String by project
val HEROKU_INTEGRATION_DB: String by project

val TRESORIER_DB_URL = System.getenv(HEROKU_TRESORIER_DB +"_URL") ?: TRESORIER_DB_URL_DFLT
val TRESORIER_DB_USR = System.getenv(HEROKU_TRESORIER_DB + "_USERNAME") ?: TRESORIER_DB_USR_DFLT
val TRESORIER_DB_PWD = System.getenv(HEROKU_TRESORIER_DB + "_PASSWORD") ?: TRESORIER_DB_PWD_DFLT

val INTEGRATION_DB_URL = System.getenv(HEROKU_INTEGRATION_DB +"_URL") ?: INTEGRATION_DB_URL_DFLT
val INTEGRATION_DB_USR = System.getenv(HEROKU_INTEGRATION_DB + "_USERNAME") ?: INTEGRATION_DB_USR_DFLT
val INTEGRATION_DB_PWD = System.getenv(HEROKU_INTEGRATION_DB + "_PASSWORD") ?: INTEGRATION_DB_PWD_DFLT
