...
export const AccountApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        updateAccount: async (accountId: string, name?: string, bankAccountId?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'accountId' is not null or undefined
...
export const AccountApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async updateAccount(accountId: string, name?: string, bankAccountId?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateAccount(accountId, name, bankAccountId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const AccountApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        updateAccount(accountId: string, name?: string, bankAccountId?: string, options?: any): AxiosPromise<string> {
            return localVarFp.updateAccount(accountId, name, bankAccountId, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class AccountApi extends BaseAPI {
     ...
     * @memberof AccountApi
     */
    public updateAccount(accountId: string, name?: string, bankAccountId?: string, options?: any) {
        return AccountApiFp(this.configuration).updateAccount(accountId, name, bankAccountId, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const BankingApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} accountId identifier of the wanted account
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getBankTransactions: async (accountId: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'accountId' is not null or undefined
            assertParamExists('getBankTransactions', 'accountId', accountId)
        ...
        getLinkForBankAgreement: async (bankId: string, options: any = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/banking/setup`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const BankingApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getBankTransactions(accountId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getBankTransactions(accountId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const BankingApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getBankTransactions(accountId: string, options?: any): AxiosPromise<string> {
            return localVarFp.getBankTransactions(accountId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary get bank agreement portal URL
...
export class BankingApi extends BaseAPI {
     ...
     * @memberof BankingApi
     */
    public getBankTransactions(accountId: string, options?: any) {
        return BankingApiFp(this.configuration).getBankTransactions(accountId, options).then((request) => request(this.axios, this.basePath));
    }
...
export const OperationApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        addOperation: async (accountId: string, day?: number, categoryId?: string, amount?: number, memo?: string, pending?: boolean, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'accountId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        updateOperation: async (operationId: string, newAccountId?: string, newDay?: number, newCategoryId?: string, newAmount?: number, newMemo?: string, newPending?: boolean, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'operationId' is not null or undefined
...
export const OperationApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async addOperation(accountId: string, day?: number, categoryId?: string, amount?: number, memo?: string, pending?: boolean, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Operation>> {
         ...
         * @throws {RequiredError}
         */
        async updateOperation(operationId: string, newAccountId?: string, newDay?: number, newCategoryId?: string, newAmount?: number, newMemo?: string, newPending?: boolean, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Operation>> {
...
export class OperationApi extends BaseAPI {
     ...
     */
    public addOperation(accountId: string, day?: number, categoryId?: string, amount?: number, memo?: string, pending?: boolean, options?: any) {
     ...
     * @memberof OperationApi
     */
    public updateOperation(operationId: string, newAccountId?: string, newDay?: number, newCategoryId?: string, newAmount?: number, newMemo?: string, newPending?: boolean, options?: any) {
