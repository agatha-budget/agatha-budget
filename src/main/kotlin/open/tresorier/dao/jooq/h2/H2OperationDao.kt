...
class H2OperationDao(val configuration: Configuration) : IOperationDao {
    ...
    override fun insert(operation: Operation): Operation {
        ...
        try {
            this.query
                .insertInto(OPERATION, OPERATION.ID, OPERATION.ACCOUNT_ID, OPERATION.DATE_MONTH, OPERATION.DATE_DAY,
                ...
                .values(jooqOperation.id, jooqOperation.accountId, jooqOperation.dateMonth, jooqOperation.dateDay, 
