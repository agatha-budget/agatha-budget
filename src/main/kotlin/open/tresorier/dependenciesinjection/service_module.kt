...
val service_module = module {
    single { AuthorizationService(get(), get(), get(), get(), get(), get(), get(), get()) }
    single { PersonService(get(), get(), get(), get(), get()) }
    ...
    single { BankingService(get(), get(), get(), get(), get(), get(), get(), get(), get()) }
