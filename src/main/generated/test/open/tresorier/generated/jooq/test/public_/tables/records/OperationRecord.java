...
public class OperationRecord extends UpdatableRecordImpl<OperationRecord> implements Record10<String, String, Integer, Integer, String, String, Integer, Long, Boolean, Boolean> {

    private static final long serialVersionUID = 1938122080;
    ...
    @Override
    public Row10<String, String, Integer, Integer, String, String, Integer, Long, Boolean, Boolean> valuesRow() {
    ...
    @Override
    public OperationRecord values(String value1, String value2, Integer value3, Integer value4, String value5, String value6, Integer value7, Long value8, Boolean value9, Boolean value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public OperationRecord(String id, String accountId, Integer month, Integer day, String categoryId, String memo, Integer amount, Long orderInDay, Boolean pending, Boolean locked) {
        super(Operation.OPERATION);
