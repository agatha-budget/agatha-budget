...
public class PersonRecord extends UpdatableRecordImpl<PersonRecord> implements Record10<String, String, String, String, Long, Integer, Boolean, String, Boolean, Long> {

    private static final long serialVersionUID = -835612385;
    ...
    @Override
    public Row10<String, String, String, String, Long, Integer, Boolean, String, Boolean, Long> valuesRow() {
    ...
    @Override
    public PersonRecord values(String value1, String value2, String value3, String value4, Long value5, Integer value6, Boolean value7, String value8, Boolean value9, Long value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PersonRecord(String id, String email, String name, String password, Long unlockingdate, Integer loginattemptcount, Boolean deleted, String billingId, Boolean billingStatus, Long creationDate) {
        super(Person.PERSON);
