...
public class BankAccount extends TableImpl<BankAccountRecord> {
     ...
     */
    public final TableField<BankAccountRecord, String> BANK_ID = createField(DSL.name("BANK_ID"), SQLDataType.VARCHAR(36).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.VARCHAR)), this, "");
    ...
    public BankAgreementPath bankAgreement() {
        if (_bankAgreement == null)
            _bankAgreement = new BankAgreementPath(this, Keys.CONSTRAINT_19, null);
    ...
    public AccountPath account() {
        if (_account == null)
            _account = new AccountPath(this, null, Keys.CONSTRAINT_E49.getInverseKey());
