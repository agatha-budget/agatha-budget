...
public class CategoryDao extends DAOImpl<CategoryRecord, open.tresorier.generated.jooq.main.tables.pojos.Category, String> {

    /**
     * Create a new CategoryDao without any configuration
     */
    public CategoryDao() {
        super(Category.CATEGORY, open.tresorier.generated.jooq.main.tables.pojos.Category.class);
    }
    ...
    public CategoryDao(Configuration configuration) {
        super(Category.CATEGORY, open.tresorier.generated.jooq.main.tables.pojos.Category.class, configuration);
    }

    @Override
    public String getId(open.tresorier.generated.jooq.main.tables.pojos.Category object) {
        return object.getId();
    }
     ...
     */
    public List<open.tresorier.generated.jooq.main.tables.pojos.Category> fetchById(String... values) {
     ...
     */
    public open.tresorier.generated.jooq.main.tables.pojos.Category fetchOneById(String value) {
     ...
     */
    public List<open.tresorier.generated.jooq.main.tables.pojos.Category> fetchRangeOfBudgetId(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<open.tresorier.generated.jooq.main.tables.pojos.Category> fetchByBudgetId(String... values) {
     ...
     */
    public List<open.tresorier.generated.jooq.main.tables.pojos.Category> fetchByName(String... values) {
     ...
     */
    public List<open.tresorier.generated.jooq.main.tables.pojos.Category> fetchByArchived(Boolean... values) {
     ...
     */
    public List<open.tresorier.generated.jooq.main.tables.pojos.Category> fetchByDeleted(Boolean... values) {
