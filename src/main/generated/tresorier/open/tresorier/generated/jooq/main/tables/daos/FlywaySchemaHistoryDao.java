...
public class FlywaySchemaHistoryDao extends DAOImpl<FlywaySchemaHistoryRecord, open.tresorier.generated.jooq.main.tables.pojos.FlywaySchemaHistory, Integer> {

    /**
     * Create a new FlywaySchemaHistoryDao without any configuration
     */
    public FlywaySchemaHistoryDao() {
        super(FlywaySchemaHistory.FLYWAY_SCHEMA_HISTORY, open.tresorier.generated.jooq.main.tables.pojos.FlywaySchemaHistory.class);
    }
    ...
    public FlywaySchemaHistoryDao(Configuration configuration) {
        super(FlywaySchemaHistory.FLYWAY_SCHEMA_HISTORY, open.tresorier.generated.jooq.main.tables.pojos.FlywaySchemaHistory.class, configuration);
    }

    @Override
    public Integer getId(open.tresorier.generated.jooq.main.tables.pojos.FlywaySchemaHistory object) {
     ...
     */
    public List<open.tresorier.generated.jooq.main.tables.pojos.FlywaySchemaHistory> fetchByInstalledRank(Integer... values) {
     ...
     */
    public open.tresorier.generated.jooq.main.tables.pojos.FlywaySchemaHistory fetchOneByInstalledRank(Integer value) {
     ...
     */
    public List<open.tresorier.generated.jooq.main.tables.pojos.FlywaySchemaHistory> fetchByVersion(String... values) {
     ...
     */
    public List<open.tresorier.generated.jooq.main.tables.pojos.FlywaySchemaHistory> fetchByDescription(String... values) {
     ...
     */
    public List<open.tresorier.generated.jooq.main.tables.pojos.FlywaySchemaHistory> fetchByType(String... values) {
     ...
     */
    public List<open.tresorier.generated.jooq.main.tables.pojos.FlywaySchemaHistory> fetchByScript(String... values) {
     ...
     */
    public List<open.tresorier.generated.jooq.main.tables.pojos.FlywaySchemaHistory> fetchByChecksum(Integer... values) {
     ...
     */
    public List<open.tresorier.generated.jooq.main.tables.pojos.FlywaySchemaHistory> fetchByInstalledBy(String... values) {
     ...
     */
    public List<open.tresorier.generated.jooq.main.tables.pojos.FlywaySchemaHistory> fetchByInstalledOn(LocalDateTime... values) {
     ...
     */
    public List<open.tresorier.generated.jooq.main.tables.pojos.FlywaySchemaHistory> fetchByExecutionTime(Integer... values) {
     ...
     */
    public List<open.tresorier.generated.jooq.main.tables.pojos.FlywaySchemaHistory> fetchBySuccess(Boolean... values) {
