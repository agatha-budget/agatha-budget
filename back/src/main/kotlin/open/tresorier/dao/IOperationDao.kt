...
interface IOperationDao {
    ...
    fun findByAccount(account: Account, category: Category? = null) : List<OperationWithDaughters>
    fun findByBudget(budget: Budget, category: Category? = null) : List<OperationWithDaughters>
