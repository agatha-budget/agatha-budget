...
public class BankAccount extends TableImpl<BankAccountRecord> {
    ...
    public BankAccount where(Condition condition) {
        return new BankAccount(getQualifiedName(), aliased() ? this : null, null, Internal.condition(this, condition));
    }
     ...
     */
    @Override
    public BankAccount whereExists(TableLike<?> select) {
     ...
     */
    @Override
    public BankAccount whereNotExists(TableLike<?> select) {
