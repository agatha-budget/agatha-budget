...
public class AccountDao extends DAOImpl<AccountRecord, open.tresorier.generated.jooq.main.tables.pojos.Account, String> {

    /**
     * Create a new AccountDao without any configuration
     */
    public AccountDao() {
        super(Account.ACCOUNT, open.tresorier.generated.jooq.main.tables.pojos.Account.class);
    }
    ...
    public AccountDao(Configuration configuration) {
        super(Account.ACCOUNT, open.tresorier.generated.jooq.main.tables.pojos.Account.class, configuration);
    }

    @Override
    public String getId(open.tresorier.generated.jooq.main.tables.pojos.Account object) {
        return object.getId();
    }
     ...
     */
    public List<open.tresorier.generated.jooq.main.tables.pojos.Account> fetchById(String... values) {
     ...
     */
    public open.tresorier.generated.jooq.main.tables.pojos.Account fetchOneById(String value) {
     ...
     */
    public List<open.tresorier.generated.jooq.main.tables.pojos.Account> fetchByBudgetId(String... values) {
     ...
     */
    public List<open.tresorier.generated.jooq.main.tables.pojos.Account> fetchByName(String... values) {
     ...
     */
    public List<open.tresorier.generated.jooq.main.tables.pojos.Account> fetchByArchived(Boolean... values) {
