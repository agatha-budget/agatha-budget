...
public class BankAccountDao extends DAOImpl<BankAccountRecord, open.tresorier.generated.jooq.main.tables.pojos.BankAccount, String> {

    /**
     * Create a new BankAccountDao without any configuration
     */
    public BankAccountDao() {
        super(BankAccount.BANK_ACCOUNT, open.tresorier.generated.jooq.main.tables.pojos.BankAccount.class);
    }
    ...
    public BankAccountDao(Configuration configuration) {
        super(BankAccount.BANK_ACCOUNT, open.tresorier.generated.jooq.main.tables.pojos.BankAccount.class, configuration);
    }

    @Override
    public String getId(open.tresorier.generated.jooq.main.tables.pojos.BankAccount object) {
        return object.getId();
    }
     ...
     */
    public List<open.tresorier.generated.jooq.main.tables.pojos.BankAccount> fetchById(String... values) {
     ...
     */
    public open.tresorier.generated.jooq.main.tables.pojos.BankAccount fetchOneById(String value) {
     ...
     */
    public List<open.tresorier.generated.jooq.main.tables.pojos.BankAccount> fetchByName(String... values) {
     ...
     */
    public List<open.tresorier.generated.jooq.main.tables.pojos.BankAccount> fetchByAgreementId(String... values) {
     ...
     */
    public List<open.tresorier.generated.jooq.main.tables.pojos.BankAccount> fetchByDeleted(Boolean... values) {
     ...
     * upperInclusive</code>
     */
    public List<open.tresorier.generated.jooq.main.tables.pojos.BankAccount> fetchRangeOfBankId(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<open.tresorier.generated.jooq.main.tables.pojos.BankAccount> fetchByBankId(String... values) {
