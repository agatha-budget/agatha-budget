...
public class BankAgreement extends TableImpl<BankAgreementRecord> {
    ...
    public BankAgreement where(Condition condition) {
        return new BankAgreement(getQualifiedName(), aliased() ? this : null, null, Internal.condition(this, condition));
    }
     ...
     */
    @Override
    public BankAgreement whereExists(TableLike<?> select) {
     ...
     */
    @Override
    public BankAgreement whereNotExists(TableLike<?> select) {
