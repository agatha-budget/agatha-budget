...
public class BankAccountDao extends DAOImpl<BankAccountRecord, open.tresorier.generated.jooq.test.public_.tables.pojos.BankAccount, String> {
     ...
     * Fetch a unique record that has <code>ID = value</code>
     */
    public Optional<open.tresorier.generated.jooq.test.public_.tables.pojos.BankAccount> fetchOptionalById(String value) {
     ...
     * upperInclusive</code>
     */
    public List<open.tresorier.generated.jooq.test.public_.tables.pojos.BankAccount> fetchRangeOfBankId(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<open.tresorier.generated.jooq.test.public_.tables.pojos.BankAccount> fetchByBankId(String... values) {
