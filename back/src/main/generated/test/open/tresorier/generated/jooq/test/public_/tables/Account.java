...
public class Account extends TableImpl<AccountRecord> {
    ...
    public BudgetPath budget() {
        if (_budget == null)
            _budget = new BudgetPath(this, Keys.CONSTRAINT_E4, null);
    ...
    public BankAccountPath bankAccount() {
        if (_bankAccount == null)
            _bankAccount = new BankAccountPath(this, Keys.CONSTRAINT_E49, null);
    ...
    public OperationPath operation() {
        if (_operation == null)
            _operation = new OperationPath(this, null, Keys.CONSTRAINT_93.getInverseKey());
