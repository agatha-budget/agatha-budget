...
public class Keys {
    ...
    public static final ForeignKey<AccountRecord, BankAccountRecord> ACCOUNT__ACCOUNT_BANK_ACCOUNT_ID_FKEY = Internal.createForeignKey(Account.ACCOUNT, DSL.name("account_bank_account_id_fkey"), new TableField[] { Account.ACCOUNT.BANK_ACCOUNT_ID }, Keys.BANK_ACCOUNT_PKEY, new TableField[] { BankAccount.BANK_ACCOUNT.ID }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<AccountRecord, BudgetRecord> ACCOUNT__ACCOUNT_BUDGET_ID_FKEY = Internal.createForeignKey(Account.ACCOUNT, DSL.name("account_budget_id_fkey"), new TableField[] { Account.ACCOUNT.BUDGET_ID }, Keys.BUDGET_PKEY, new TableField[] { Budget.BUDGET.ID }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<AllocationRecord, CategoryRecord> ALLOCATION__ALLOCATION_CATEGORY_ID_FKEY = Internal.createForeignKey(Allocation.ALLOCATION, DSL.name("allocation_category_id_fkey"), new TableField[] { Allocation.ALLOCATION.CATEGORY_ID }, Keys.CATEGORY_PKEY, new TableField[] { Category.CATEGORY.ID }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<BankAccountRecord, BankAgreementRecord> BANK_ACCOUNT__BANK_ACCOUNT_AGREEMENT_ID_FKEY = Internal.createForeignKey(BankAccount.BANK_ACCOUNT, DSL.name("bank_account_agreement_id_fkey"), new TableField[] { BankAccount.BANK_ACCOUNT.AGREEMENT_ID }, Keys.BANK_AGREEMENT_PKEY, new TableField[] { BankAgreement.BANK_AGREEMENT.ID }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<BankAgreementRecord, BudgetRecord> BANK_AGREEMENT__BANK_AGREEMENT_BUDGET_ID_FKEY = Internal.createForeignKey(BankAgreement.BANK_AGREEMENT, DSL.name("bank_agreement_budget_id_fkey"), new TableField[] { BankAgreement.BANK_AGREEMENT.BUDGET_ID }, Keys.BUDGET_PKEY, new TableField[] { Budget.BUDGET.ID }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<BudgetRecord, PersonRecord> BUDGET__BUDGET_PERSON_ID_FKEY = Internal.createForeignKey(Budget.BUDGET, DSL.name("budget_person_id_fkey"), new TableField[] { Budget.BUDGET.PERSON_ID }, Keys.PERSON_PKEY, new TableField[] { Person.PERSON.ID }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    ...
    public static final ForeignKey<MasterCategoryRecord, BudgetRecord> MASTER_CATEGORY__MASTER_CATEGORY_BUDGET_ID_FKEY = Internal.createForeignKey(MasterCategory.MASTER_CATEGORY, DSL.name("master_category_budget_id_fkey"), new TableField[] { MasterCategory.MASTER_CATEGORY.BUDGET_ID }, Keys.BUDGET_PKEY, new TableField[] { Budget.BUDGET.ID }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<OperationRecord, AccountRecord> OPERATION__OPERATION_ACCOUNT_ID_FKEY = Internal.createForeignKey(Operation.OPERATION, DSL.name("operation_account_id_fkey"), new TableField[] { Operation.OPERATION.ACCOUNT_ID }, Keys.ACCOUNT_PKEY, new TableField[] { Account.ACCOUNT.ID }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<OperationRecord, CategoryRecord> OPERATION__OPERATION_CATEGORY_ID_FKEY = Internal.createForeignKey(Operation.OPERATION, DSL.name("operation_category_id_fkey"), new TableField[] { Operation.OPERATION.CATEGORY_ID }, Keys.CATEGORY_PKEY, new TableField[] { Category.CATEGORY.ID }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
}
