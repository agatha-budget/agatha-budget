...
public class MasterCategory extends TableImpl<MasterCategoryRecord> {
     ...
     */
    public final TableField<MasterCategoryRecord, String> COLOR = createField(DSL.name("COLOR"), SQLDataType.VARCHAR(36).defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.VARCHAR)), this, "");
    ...
    public BudgetPath budget() {
        if (_budget == null)
            _budget = new BudgetPath(this, Keys.CONSTRAINT_D3, null);
    ...
    public CategoryPath category() {
        if (_category == null)
            _category = new CategoryPath(this, null, Keys.CONSTRAINT_31.getInverseKey());
