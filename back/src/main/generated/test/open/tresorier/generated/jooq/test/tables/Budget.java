...
import open.tresorier.generated.jooq.test.tables.Person.PersonPath;
...
public class Budget extends TableImpl<BudgetRecord> {
    ...
    public Budget where(Condition condition) {
        return new Budget(getQualifiedName(), aliased() ? this : null, null, Internal.condition(this, condition));
    }
     ...
     */
    @Override
    public Budget whereExists(TableLike<?> select) {
     ...
     */
    @Override
    public Budget whereNotExists(TableLike<?> select) {
